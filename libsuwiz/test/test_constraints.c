...
void test_suwiz_constraints_is_value(void) {
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b0000));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_IS_VALUE(0b0001));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_IS_VALUE(0b0010));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_IS_VALUE(0b0100));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_IS_VALUE(0b1000));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_IS_VALUE(0b0110));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_IS_VALUE(0b1111));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b10000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b100000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b1000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b10000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b100000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b1000000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b10000000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b100000000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b1000000000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b0011111000000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_IS_VALUE(0b1111111110000));
}
...
void test_suwiz_constraints_has_choice(void) {
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_HAS_CHOICE(0b10000, 0b10000));
    CU_ASSERT_TRUE(SUWIZ_CONSTRAINTS_HAS_CHOICE(0b11000, 0b01000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_HAS_CHOICE(0b01000, 0b110000));
    CU_ASSERT_TRUE(!SUWIZ_CONSTRAINTS_HAS_CHOICE(0b100000, 0b010000));
}
